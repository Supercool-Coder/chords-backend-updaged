...
class UserSerializer(serializers.ModelSerializer):
  ...
  class Meta:
    model = User
    # fields= ('__all__')
    fields=['id','code','email', 'name','role', 'password','phone','avatar','remember_token','login_mode','status','is_active' , 'user_type', 'auth_provider' ,'auth_token']
    extra_kwargs={
...
class UserRegistrationSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['email', 'name', 'password', 'role', 'phone', 'auth_provider', 'auth_token']
        extra_kwargs = {
            'password': {'write_only': True},
...
class UserInformationSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'last_login', 'code', 'email', 'name', 'role', 'username', 'phone', 'avatar',  'login_mode', ]
